...
void PluginManagerDialog::onInstallSucceeded(const QString &installPath)
{
    ...
    appendLog(tr("Restart tbc-analyse for the change to take effect."));
    setBusy(false);
    updateStatusDisplay();
    QMessageBox::information(this, tr("Install complete"),
        tr("The plugin was installed successfully.\n\n"
           "Restart tbc-analyse for the change to take effect."));
}
...
void PluginManagerDialog::onRemove()
{
    ...
    auto confirm = QMessageBox::question(this, tr("Remove %1").arg(plugin.displayName),
        tr("This will delete the installed %1.\n\n"
           "Restart tbc-analyse after removal for the change to take effect.\n\nContinue?")
...
{
    appendLog(tr("Removed. Restart tbc-analyse for the change to take effect."));
    setBusy(false);
    updateStatusDisplay();
