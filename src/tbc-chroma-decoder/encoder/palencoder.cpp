/************************************************************************
    ...
    tbc-chroma-encoder - Composite video encoder
    Copyright (C) 2019-2022 Adam Sampson

    This file is part of tbc-tools.

    tbc-chroma-encoder is free software: you can redistribute it and/or
    ...
    : Encoder(_inputFile, _tbcFile, _chromaFile, _metaData, _fieldOffset, _isComponent), scLocked(_scLocked)
{
    ...
    // horizontal samples at 4fSC, but tbc-chroma-decoder expands both sides to
